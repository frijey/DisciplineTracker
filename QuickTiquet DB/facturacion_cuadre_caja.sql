...
CREATE TABLE `cuadre_caja` (
  `cod_cua_caj` int(11) NOT NULL AUTO_INCREMENT,
  `fk_usu_cua_caj` int(11) DEFAULT NULL,
  `fec_cua_caj` date DEFAULT NULL,
  `hor_cua_caj` time DEFAULT NULL,
  `tot_cua_caj` decimal(12,2) DEFAULT NULL,
  PRIMARY KEY (`cod_cua_caj`),
  KEY `fk_usu_idx` (`fk_usu_cua_caj`),
  CONSTRAINT `fk_usu` FOREIGN KEY (`fk_usu_cua_caj`) REFERENCES `usuario` (`cod_usu`)
) ENGINE=InnoDB;
