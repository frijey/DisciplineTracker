namespace SFG
{
    partial class FrmMantenimientoDetalle_cuadre_caja
    {
        /// <summary>
        ...
        {
            this.btnGrabar.ClaseATrabajar = Controles.listado.Detalle_cuadre_caja;
            this.btnGrabar.MyTextBoxID = this.txtd1fk_cua_caj;
            this.btnGrabar.Procedimiento = "SentenciaDetalle_cuadre_caja";
            this.btnEliminar.ClaseATrabajar = Controles.listado.Detalle_cuadre_caja;
            this.btnEliminar.MyTextBoxID = this.txtd1fk_cua_caj;
            this.btnEliminar.Procedimiento = "SentenciaDetalle_cuadre_caja";
this.lbldc5tot_det_cua_caj = new Controles.LabelNormalCustom();
            
            //
            // lbldc5tot_det_cua_caj
            //
            this.lbldc5tot_det_cua_caj.AutoSize = true;
            this.lbldc5tot_det_cua_caj.Location = new System.Drawing.Point(36, 161);
            this.lbldc5tot_det_cua_caj.Name = "lbldc5tot_det_cua_caj";
            this.lbldc5tot_det_cua_caj.Text = "Tot_det_cua_caj";

this.txtd5tot_det_cua_caj = new Controles.TextBoxCustom();
                        //
            // txtd5tot_det_cua_caj
            //
            this.txtd5tot_det_cua_caj.DefaultValue = "0.00";
            this.txtd5tot_det_cua_caj.Text = "0.00";
            this.txtd5tot_det_cua_caj.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            this.txtd5tot_det_cua_caj.Enabled = false;
            this.txtd5tot_det_cua_caj.id = "tot_det_cua_caj";
            this.txtd5tot_det_cua_caj.Limpiar = true;
            this.txtd5tot_det_cua_caj.Location = new System.Drawing.Point(140, 158);
            this.txtd5tot_det_cua_caj.Name = "txtd5tot_det_cua_caj";
            this.txtd5tot_det_cua_caj.NeedAlert = false;
            this.txtd5tot_det_cua_caj.obligatorio = true;
            this.txtd5tot_det_cua_caj.ObligatorioDinamico = 1;
            this.txtd5tot_det_cua_caj.MaxLength = 17;
            this.txtd5tot_det_cua_caj.TipoValidacion = Controles.Validacion.Dinero;
            this.txtd5tot_det_cua_caj.Size = new System.Drawing.Size(100, 20);
            this.txtd5tot_det_cua_caj.TabIndex = 4;
this.lbldc4hor_det_cua_caj = new Controles.LabelNormalCustom();
            
            //
            // lbldc4hor_det_cua_caj
            //
            this.lbldc4hor_det_cua_caj.AutoSize = true;
            this.lbldc4hor_det_cua_caj.Location = new System.Drawing.Point(36, 135);
            this.lbldc4hor_det_cua_caj.Name = "lbldc4hor_det_cua_caj";
            this.lbldc4hor_det_cua_caj.Text = "Hor_det_cua_caj";

this.txtd4hor_det_cua_caj = new Controles.TextBoxCustom();
                        //
            // txtd4hor_det_cua_caj
            //
            this.txtd4hor_det_cua_caj.DefaultValue = "";
            this.txtd4hor_det_cua_caj.Text = "";
            this.txtd4hor_det_cua_caj.Enabled = false;
            this.txtd4hor_det_cua_caj.id = "hor_det_cua_caj";
            this.txtd4hor_det_cua_caj.Limpiar = true;
            this.txtd4hor_det_cua_caj.Location = new System.Drawing.Point(140, 132);
            this.txtd4hor_det_cua_caj.Name = "txtd4hor_det_cua_caj";
            this.txtd4hor_det_cua_caj.NeedAlert = false;
            this.txtd4hor_det_cua_caj.obligatorio = true;
            this.txtd4hor_det_cua_caj.ObligatorioDinamico = 1;
            this.txtd4hor_det_cua_caj.Size = new System.Drawing.Size(100, 20);
            this.txtd4hor_det_cua_caj.TabIndex = 3;
this.lbldc3fec_det_cua_caj = new Controles.LabelNormalCustom();
            
            //
            // lbldc3fec_det_cua_caj
            //
            this.lbldc3fec_det_cua_caj.AutoSize = true;
            this.lbldc3fec_det_cua_caj.Location = new System.Drawing.Point(36, 109);
            this.lbldc3fec_det_cua_caj.Name = "lbldc3fec_det_cua_caj";
            this.lbldc3fec_det_cua_caj.Text = "Fec_det_cua_caj";

this.dateCustom3fec_det_cua_caj = new Controles.dateCustom();
                        //
            // dateCustom3fec_det_cua_caj
            //
            this.dateCustom3fec_det_cua_caj.Format = System.Windows.Forms.DateTimePickerFormat.Short;
            this.dateCustom3fec_det_cua_caj.id = "fec_det_cua_caj";
            this.dateCustom3fec_det_cua_caj.Limpiar = true;
            this.dateCustom3fec_det_cua_caj.Location = new System.Drawing.Point(140, 106);
            this.dateCustom3fec_det_cua_caj.Name = "dateCustom3fec_det_cua_caj";
            this.dateCustom3fec_det_cua_caj.NeedAlert = false;
            this.dateCustom3fec_det_cua_caj.obligatorio = true;
            this.dateCustom3fec_det_cua_caj.ObligatorioDinamico = 1;
            this.dateCustom3fec_det_cua_caj.Size = new System.Drawing.Size(105, 20);
            this.dateCustom3fec_det_cua_caj.TabIndex = 2;
            this.dateCustom3fec_det_cua_caj.Value = new System.DateTime(2019, 1, 1, 12, 00, 00, 001);
            this.dateCustom3fec_det_cua_caj.Enabled = false;
...
this.LabelN1fk_cua_caj = new Controles.LabelNormalCustom();
            
            //
            // LabelN1fk_cua_caj
            //
            this.LabelN1fk_cua_caj.AutoSize = true;
            this.LabelN1fk_cua_caj.Location = new System.Drawing.Point(36, 57);
            this.LabelN1fk_cua_caj.Name = "LabelN1fk_cua_caj";
            this.LabelN1fk_cua_caj.Size = new System.Drawing.Size(15, 13);
            this.LabelN1fk_cua_caj.Text = "Fk_cua_caj";

this.txtd1fk_cua_caj = new Controles.TextBoxCustom();
                        //
            // txtd1fk_cua_caj
            //
            this.txtd1fk_cua_caj.DefaultValue = "Nuevo";
            this.txtd1fk_cua_caj.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            this.txtd1fk_cua_caj.Text = "NUEVO";
            this.txtd1fk_cua_caj.Enabled = false;
            this.txtd1fk_cua_caj.id = "fk_cua_caj";
            this.txtd1fk_cua_caj.Limpiar = true;
            this.txtd1fk_cua_caj.Location = new System.Drawing.Point(140, 54);
            this.txtd1fk_cua_caj.Name = "txtd1fk_cua_caj";
            this.txtd1fk_cua_caj.NeedAlert = false;
            this.txtd1fk_cua_caj.obligatorio = false;
            this.txtd1fk_cua_caj.ObligatorioDinamico = 1;
            this.txtd1fk_cua_caj.DefaultEnabledFalse = true;
            this.txtd1fk_cua_caj.Size = new System.Drawing.Size(100, 20);
            this.txtd1fk_cua_caj.TabIndex = 0;
            this.SuspendLayout();
            // 
            // FrmMantenimientoDetalle_cuadre_caja
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(861, 519);
            this.tabPageRegistro.Controls.Add(this.txtd1fk_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.LabelN1fk_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.txtd2fk_cod_fac);
            
            this.tabPageRegistro.Controls.Add(this.lbldc2fk_cod_fac);
            
            this.tabPageRegistro.Controls.Add(this.dateCustom3fec_det_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.lbldc3fec_det_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.txtd4hor_det_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.lbldc4hor_det_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.txtd5tot_det_cua_caj);
            
            this.tabPageRegistro.Controls.Add(this.lbldc5tot_det_cua_caj);
            
            this.txtd5tot_det_cua_caj.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtd5tot_det_cua_caj_KeyPress);
            this.txtd5tot_det_cua_caj.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(this.txtd5tot_det_cua_caj_PreviewKeyDown);
            ...
            this.Column1.DataPropertyName = "fk_cua_caj";
...
this.Name = "FrmMantenimientoDetalle_cuadre_caja";
            this.ShowInTaskbar = false;
            this.Text = "Formulario Heredable";
            this.Load += new System.EventHandler(this.FrmMantenimientoDetalle_cuadre_caja_Load);
        ...
        public Controles.LabelNormalCustom lbldc5tot_det_cua_caj;
        public Controles.TextBoxCustom txtd5tot_det_cua_caj;
        public Controles.LabelNormalCustom lbldc4hor_det_cua_caj;
        public Controles.TextBoxCustom txtd4hor_det_cua_caj;
        public Controles.LabelNormalCustom lbldc3fec_det_cua_caj;
        public Controles.dateCustom dateCustom3fec_det_cua_caj;
        public Controles.LabelNormalCustom lbldc2fk_cod_fac;
        public Controles.TextBoxCustom txtd2fk_cod_fac;
        public Controles.LabelNormalCustom LabelN1fk_cua_caj;
        public Controles.TextBoxCustom txtd1fk_cua_caj;
    }
}