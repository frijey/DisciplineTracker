...
namespace SFG
{
    public partial class FrmMantenimientoProveedor : Bases.MantenimientoBase
    {
        ...
        Modelo.Proveedor Proveedor = new Proveedor();
                ...
                {
                    if (!Tools.LlenarEntidadDesdeControlesPersonalizados(this, tabPageRegistro, Proveedor).Item2)
                    {
                        if (Nuevo)
                        {
                            Sentencia = Proveedor.Sentencia(Proveedor, "I");
                            if (Sentencia.Item2)
                            {
                                txtd1cod_pro.Text = Sentencia.Item1.ToString();
                            }
                        }
                        else
                        {
                            Sentencia = Proveedor.Sentencia(Proveedor, "U");
                        }
                ...
                protected override void Eliminar(Object sender, EventArgs e)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Proveedor.cod_pro = Convert.ToInt32(txtd1cod_pro.Text);
                            Sentencia = Proveedor.Sentencia(Proveedor, "D");
        ...
        {
            PrimerControlEdicion = txtd2nom_pro;
            UltimoControlEdicion = txtd9rnc_pro;
...
/*AddEventsOnLoad*/
        ...
        private void txtd9rnc_pro_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 9)
            {
                e.Handled = false;
        ...
        private void txtd9rnc_pro_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
                ...
                public void BuscarPor()
        {
            ...
            {
                try { dataGridViewNormal2.DataSource = Proveedor.ListadoGeneral(txtParametro.Text.Trim()); } catch (Exception exc) { MessageBox.Show(exc.Message); }
        ...
        public void MostrarTodo(object sender = null, EventArgs e = null)
        {
            try
            {
                dataGridViewNormal2.DataSource = Proveedor.ListadoGeneral();
                lblCantidad.Text = "Items: " + dataGridViewNormal2.Rows.Count.ToString();
        ...
        public void CargarRegistro(string prm_id)
        {
            ...
            ActivarYDesactivarBotonesPorGrupo("1", true);
            btnModificar.Focus();
            DataTable DT = Proveedor.SProveedor(prm_id);
